...
const Project = () => {
    ...
    return (
        <div className="items-center">
            ...
            <div className="w-[50px] flex justify-center  bg-gray-200/30 backdrop-blur-lg rounded-md border border-gray-200/30 shadow-lg mt-[30px] mx-auto">
                <a href="https://github.com/starkoka/Stellarculator">
